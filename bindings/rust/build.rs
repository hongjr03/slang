...
fn build_cpp_lib(cxxbridge_dir: &Path, debug: bool, use_mimalloc: bool) -> PathBuf {
    ...
    config
        ...
        .define("SLANG_USE_MIMALLOC", if use_mimalloc { "ON" } else { "OFF" })
...
fn setup_linking(install_dir: &Path, debug: bool, use_mimalloc: bool) {
    ...
    if use_mimalloc {
        ...
        let mimalloc_lib = if target_env == "msvc" {
